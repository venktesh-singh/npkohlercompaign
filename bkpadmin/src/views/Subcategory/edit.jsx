...
const SubCategoryUpdate = () => {
    ...
    useEffect(() => {
        if (updateSubcategory.subcat_name) {
            const generatedUrl = updateSubcategory.subcat_name
                .toLowerCase()
                .replace(/'s/g, '') 
                .replace(/[^a-z0-9]+/g, '-') 
                .replace(/^-+|-+$/g, ''); 
    
                setUpdateSubcategory((prevCategory) => ({
                ...prevCategory,
                subcat_url: generatedUrl,
            }));
        }
    }, [updateSubcategory.subcat_name]);
                                    ...
                                    <Col md={6}>
                                        <Form.Group controlId="formCategoryUrl">
                                            ...
                                            <Form.Control
                                                ...
                                                name="subcat_url"
                                                value={updateSubcategory.subcat_url}
                                                onChange={handleChange}
                                            />
                                        </Form.Group>
                                    </Col>
