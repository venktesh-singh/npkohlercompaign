...
const AddSubCategory = () => {
    ...
    useEffect(() => {
        if (addSubcategory.subcat_name) {
            const generatedUrl = addSubcategory.subcat_name
                .toLowerCase()
                .replace(/'s/g, '') 
                .replace(/[^a-z0-9]+/g, '-') 
                .replace(/^-+|-+$/g, ''); 
    
                setAddSubcategory((prevCategory) => ({
                ...prevCategory,
                subcat_url: generatedUrl,
            }));
        }
    }, [addSubcategory.subcat_name]);
                                    ...
                                    <Col md={6}>
                                        <Form.Group controlId="formCategoryUrl">
                                            ...
                                            <Form.Control
                                                ...
                                                name="subcat_url"
                                                value={addSubcategory.subcat_url}
                                                onChange={handleChange}
                                            />
                                        </Form.Group>
                                    </Col>
